...
export const MensajeCompartir = "Conoce POS - STO. Un punto de venta completo.";
export const EnlaceCompartir = encodeURIComponent("https://github.com/Joss852");
export const EnlaceCompartirParaHumanos = "github.com/Joss852";
export const CorreoSoporteYContacto = "jjosseph.morales@gmail.com";
export const TimeoutOcultarMenuTickets = 200;
export const PuertoApi = "2106"; // Debe coincidir con Constantes.go
export const UsuarioPorDefecto = "root"; // Debe coincidir con Constantes.go