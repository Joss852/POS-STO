              ...
              <v-card flat>
                <v-card-text>
                  ...
                  <v-select
                    ...
                    item-text="descripcion"
                    item-value="indice"
                    label="La columna que tiene el embalaje del producto es la número..."
                    outline
                    v-model="configuracionParaImportar.IndiceEmbalaje"
                  ></v-select>
                  <v-select
                    :items="indicesColumnas"
                    item-text="descripcion"
    ...
    methods: {
      ...
      importar() {
        ...
        if (archivos.length > 0) {
          ...
          formData.append("IndiceEmbalaje", this.configuracionParaImportar.IndiceEmbalaje.toString());
