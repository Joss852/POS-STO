        ...
        <v-form ref="formulario">
          <v-container fluid grid-list-md>
            <v-layout row wrap>
              ...
              <v-flex xs12>
                  <v-select
                    :items="indicesEmbalaje"
                    item-text="texto"
                    item-value="valor"
                    label="Embalaje"
                    outline
                    v-model="configuracionParaEmbalaje.IndiceKg"
                    :rules="reglas.embalaje"
                  ></v-select>
              </v-flex>
              <v-flex xs12>
  ...
  export default {
    ...
    data: () => ({
      ...
      reglas: {
        ...
        embalaje: [
          embalaje => {
            if (!embalaje) return "Seleccione el embalaje del producto";
            return true;
          }
        ],
        precios: [
