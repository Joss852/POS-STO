        ...
        <v-card class="cursor-manita text-xs-center" style="min-height: 250px;" @click.native="irA('Inventario')">
          ...
          <v-card-title primary-title>
            <div>
              ...
              <span class="grey--text">Registrar, eliminar o actualizar detalles de productos</span>
            </div>
          </v-card-title>
        </v-card>
      </v-flex>
        ...
        <v-card class="cursor-manita text-xs-center" style="min-height: 250px;" @click.native="irA('Clientes')">
          ...
          <v-card-title primary-title>
            <div>
              ...
              <span class="grey--text">Registrar, eliminar o actualizar detalles de clientes</span>
            </div>
          </v-card-title>
        </v-card>
      </v-flex>
