...
type AjustesParaImportarProductos struct {
	...
	IndiceCodigoBarras, IndiceDescripcion, IndiceEmbalaje, IndicePrecioCompra, IndicePrecioVenta, IndiceExistencia, IndiceStock int
}
...
type Producto struct {
	Numero                                       int
	Descripcion, CodigoBarras, Embalaje          string
